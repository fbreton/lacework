...
This script is to be use with Oh My Zsh framework to get lacework command completion.
...
## Instalation
To use the lacework completion you need to:
  ...
  3. edit your ~/.zshrc file, find the line starting by plugins to add lacework to the plugins list, you should at list have: `plugins=(lacemork)`
